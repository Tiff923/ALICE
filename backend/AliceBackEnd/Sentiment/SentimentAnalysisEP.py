...
def analyze_sentiment_pattern_lexicon(text, threshold = 0.1):
    ...
    returnJson = {"sentiment":"none", "positivity":0, "negativity":0, "subjectivity":sentiment_subjectivity}
    #Get final Sentiment
    if sentiment_score > threshold:
        final_sentiment = "Positive"
        returnJson["positivity"] = sentiment_score
        returnJson["sentiment"] = final_sentiment
    else:
        final_sentiment = "Negative"
        returnJson["negativity"] = sentiment_score
        returnJson["sentiment"] = final_sentiment
    return returnJson
