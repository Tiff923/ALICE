...
def download_wiki80(root_path=default_root_path):
    ...
    if not os.path.exists(os.path.join(root_path, 'benchmark/wiki80')):
        ...
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/wiki80') + ' ' + root_url +
                  'opennre/benchmark/wiki80/wiki80_rel2id.json')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/wiki80') + ' ' + root_url +
                  'opennre/benchmark/wiki80/wiki80_train.txt')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/wiki80') + ' ' + root_url +
                  'opennre/benchmark/wiki80/wiki80_val.txt')
...
def download_nyt10(root_path=default_root_path):
    ...
    if not os.path.exists(os.path.join(root_path, 'benchmark/nyt10')):
        ...
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/nyt10') + ' ' + root_url +
                  'opennre/benchmark/nyt10/nyt10_rel2id.json')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/nyt10') + ' ' + root_url +
                  'opennre/benchmark/nyt10/nyt10_train.txt')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/nyt10') + ' ' + root_url +
                  'opennre/benchmark/nyt10/nyt10_test.txt')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/nyt10') + ' ' + root_url +
                  'opennre/benchmark/nyt10/nyt10_val.txt')
...
def download_semeval(root_path=default_root_path):
    ...
    if not os.path.exists(os.path.join(root_path, 'benchmark/semeval')):
        ...
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/semeval') + ' ' + root_url +
                  'opennre/benchmark/semeval/semeval_rel2id.json')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/semeval') + ' ' + root_url +
                  'opennre/benchmark/semeval/semeval_train.txt')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/semeval') + ' ' + root_url +
                  'opennre/benchmark/semeval/semeval_test.txt')
        os.system('wget -P ' + os.path.join(root_path, 'benchmark/semeval') + ' ' + root_url +
                  'opennre/benchmark/semeval/semeval_val.txt')
...
def download_glove(root_path=default_root_path):
    ...
    if not os.path.exists(os.path.join(root_path, 'pretrain/glove')):
        ...
        os.system('wget -P ' + os.path.join(root_path, 'pretrain/glove') + ' ' + root_url +
                  'opennre/pretrain/glove/glove.6B.50d_mat.npy')
        os.system('wget -P ' + os.path.join(root_path, 'pretrain/glove') + ' ' + root_url +
                  'opennre/pretrain/glove/glove.6B.50d_word2id.json')
...
def download_bert_base_uncased(root_path=default_root_path):
    ...
    if not os.path.exists(os.path.join(root_path, 'pretrain/bert-base-uncased')):
        ...
        os.system('wget -P ' + os.path.join(root_path, 'pretrain/bert-base-uncased') + ' ' + root_url +
                  'opennre/pretrain/bert-base-uncased/config.json')
        os.system('wget -P ' + os.path.join(root_path, 'pretrain/bert-base-uncased') + ' ' + root_url +
                  'opennre/pretrain/bert-base-uncased/pytorch_model.bin')
        os.system('wget -P ' + os.path.join(root_path, 'pretrain/bert-base-uncased') + ' ' + root_url +
                  'opennre/pretrain/bert-base-uncased/vocab.txt')
...
def download_pretrain(model_name, root_path=default_root_path):
    ...
    if not os.path.exists(ckpt):
        os.system('wget -P ' + os.path.join(root_path,
                                            'pretrain/nre') + ' ' + root_url + 'opennre/pretrain/nre/' + model_name + '.pth.tar')
